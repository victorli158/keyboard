...
class Game {
  ...
  playMary() {
    ...
    if (this.notes.length === 0) {
      ...
      window.setTimeout(this.counter[0].grade, 20000);
  ...
  playMia() {
    ...
    if (this.notes.length === 0) {
      ...
      window.setTimeout(this.counter[0].grade, 62000);
      ...
      this.add(new Note({ game: this, key: "j", vel: 3, pos: [keyWidth * 5, -6500], color: "#39FF14", tone: "c5#"}));
      // measure
      this.add(new Note({ game: this, key: "s", vel: 3, pos: [0, -6650], color: "#39FF14", tone: "e4"}));
      this.add(new Note({ game: this, key: "d", vel: 3, pos: [keyWidth * 1, -6800], color: "#39FF14", tone: "f4"}));
      this.add(new Note({ game: this, key: "f", vel: 3, pos: [keyWidth * 2, -6950], color: "#39FF14", tone: "f4#"}));
      this.add(new Note({ game: this, key: "g", vel: 3, pos: [keyWidth * 3, -7100], color: "#39FF14", tone: "a4"}));
      this.add(new Note({ game: this, key: "j", vel: 3, pos: [keyWidth * 5, -7250], color: "#39FF14", tone: "c5#"}));
      // measure
      this.add(new Note({ game: this, key: "k", vel: 3, pos: [keyWidth * 6, -7400], color: "#39FF14", tone: "f5#"}));
      this.add(new Note({ game: this, key: "j", vel: 3, pos: [keyWidth * 5, -7475], color: "#39FF14", tone: "e5"}));
      this.add(new Note({ game: this, key: "h", vel: 3, pos: [keyWidth * 4, -7550], color: "#39FF14", tone: "d5"}));
      this.add(new Note({ game: this, key: "j", vel: 3, pos: [keyWidth * 5, -7625], color: "#39FF14", tone: "e5"}));
      this.add(new Note({ game: this, key: "h", vel: 3, pos: [keyWidth * 4, -7700], color: "#39FF14", tone: "d5"}));
      this.add(new Note({ game: this, key: "g", vel: 3, pos: [keyWidth * 3, -7775], color: "#39FF14", tone: "c5#"}));
      this.add(new Note({ game: this, key: "d", vel: 3, pos: [keyWidth, -7850], color: "#39FF14", tone: "b4"}));
      // measure
      this.add(new Note({ game: this, key: "l", vel: 3, pos: [keyWidth * 7, -8300], color: "#39FF14", tone: "g5#"}));
      this.add(new Note({ game: this, key: "k", vel: 3, pos: [keyWidth * 6, -8375], color: "#39FF14", tone: "f5#"}));
      this.add(new Note({ game: this, key: "j", vel: 3, pos: [keyWidth * 5, -8450], color: "#39FF14", tone: "f5"}));
      this.add(new Note({ game: this, key: "h", vel: 3, pos: [keyWidth * 4, -8525], color: "#39FF14", tone: "d5"}));
      this.add(new Note({ game: this, key: "g", vel: 3, pos: [keyWidth * 3, -8600], color: "#39FF14", tone: "c5#"}));
      this.add(new Note({ game: this, key: "f", vel: 3, pos: [keyWidth * 2, -8675], color: "#39FF14", tone: "b4"}));
      this.add(new Note({ game: this, key: "d", vel: 3, pos: [keyWidth, -8750], color: "#39FF14", tone: "a4"}));
      // measure
      this.add(new Note({ game: this, key: "s", vel: 3, pos: [0, -9200], color: "#39FF14", tone: "f4#"}));
      this.add(new Note({ game: this, key: "d", vel: 3, pos: [keyWidth, -9275], color: "#39FF14", tone: "g4#"}));
      this.add(new Note({ game: this, key: "s", vel: 3, pos: [0, -9350], color: "#39FF14", tone: "f4#"}));
      this.add(new Note({ game: this, key: "d", vel: 3, pos: [keyWidth, -9425], color: "#39FF14", tone: "g4#"}));
      this.add(new Note({ game: this, key: "f", vel: 3, pos: [keyWidth * 2, -9500], color: "#39FF14", tone: "a4"}));
      this.add(new Note({ game: this, key: "s", vel: 3, pos: [0, -9650], color: "#39FF14", tone: "f4#"}));
      this.add(new Note({ game: this, key: "d", vel: 3, pos: [keyWidth, -9725], color: "#39FF14", tone: "g4#"}));
      this.add(new Note({ game: this, key: "s", vel: 3, pos: [0, -9800], color: "#39FF14", tone: "f4#"}));
      this.add(new Note({ game: this, key: "d", vel: 3, pos: [keyWidth, -9875], color: "#39FF14", tone: "g4#"}));
      this.add(new Note({ game: this, key: "f", vel: 3, pos: [keyWidth * 2, -9950], color: "#39FF14", tone: "a4"}));
      // measure
      this.add(new Note({ game: this, key: "s", vel: 3, pos: [0, -10100], color: "#39FF14", tone: "f4#"}));
      this.add(new Note({ game: this, key: "d", vel: 3, pos: [keyWidth, -10175], color: "#39FF14", tone: "g4#"}));
      this.add(new Note({ game: this, key: "s", vel: 3, pos: [0, -10250], color: "#39FF14", tone: "f4#"}));
      this.add(new Note({ game: this, key: "d", vel: 3, pos: [keyWidth, -10325], color: "#39FF14", tone: "g4#"}));
      this.add(new Note({ game: this, key: "f", vel: 3, pos: [keyWidth * 2, -10400], color: "#39FF14", tone: "a4"}));
      this.add(new Note({ game: this, key: "s", vel: 3, pos: [0, -10475], color: "#39FF14", tone: "f4#"}));
      this.add(new Note({ game: this, key: "g", vel: 3, pos: [keyWidth * 3, -10550], color: "#39FF14", tone: "b4"}));
    }
  }
